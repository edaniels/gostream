...
const UI = {
    ...
    start() {
        ...
        Array.from(document.getElementsByClassName('noVNC_version')).forEach(el => el.innerText = '1.2.0');
    ...
    async initSettings() {
        ...
        UI.initSetting('logging', 'debug', true);
        UI.updateLogging();
        ...
        UI.initSetting('show_dot', true, true);
        UI.initSetting('path', 'vnc_ws', true);
